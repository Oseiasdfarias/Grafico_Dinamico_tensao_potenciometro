...
plt.xlabel("Tempo (s)", color='dimgray', fontdict={'fontsize': 12, 'fontweight': 'medium'})
plt.ylabel("Ângulo (G°)", color='dimgray', fontdict={'fontsize': 12, 'fontweight': 'medium'})

# Inicializa as configurações no gráfico quando inicializa a plotagem dinâmica.
def init():
    ax.set_ylim(-30, 330)
    ax.set_title("Sensor de Ângulo com Potenciômetro", color='dimgray', fontdict={'fontsize': 18, 'fontweight': 'medium'})
    return ln,
